...
export function Editor({
  ...
  return (
    <>
      {/* Small screens get a focused studio instead of the cramped full editor. */}
      <MobileStudio allTemplates={allTemplates} />

      {/* Full desktop studio — controls + live preview side by side. */}
      <div className="hidden gap-6 lg:grid lg:grid-cols-[360px_1fr]">
        {/* Controls */}
        <div className="space-y-6">
          ...
          <Section title="Style" icon={<Sparkles className="size-4" />}>
          ...
          <Section title="Effects" icon={<Wand2 className="size-4" />}>
